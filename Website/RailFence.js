...
function ShowGrid()
{
    //takes in the text entered in the text box
    var input = document.getElementById("message").value;
    //removes any non alphatbetical characters
    input = input.replace(/[^a-z]/gi, '');
    ...
    //creates three input strings, one for each rail
    var input1 = "";
    var input2 = "";
    var input3 = "";
    ...
    var input1_null = "";
    //loops through the first input string
    ...
    //prints out all of the strings on new lines in the correct text box
    document.getElementById("GridTextBox").innerHTML = input1 + "\n" + input2 + "\n" + input3;
}
